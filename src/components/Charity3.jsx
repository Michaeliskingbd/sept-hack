...
import ahhkids from '../assets/Groupofkids.jpg';
          ...
          <div className="md:col-span-7 flex flex-col md:pl-16 pt-4">
            ...
            <div className="mb-8">
              <h2 className="text-[42px] font-bold leading-[1.1] mb-6">
                Bringing Dreams <br /> within reach for <br /> Children
              </h2>
            ...
            <div className="md:pl-[300px]">
              <p className="text-gray-500 text-[20px]  font-light">
                Under priviledge children often lack the financial support
                and basic resources they need to pursue their dreams
                and reach their full potential. We step in to provide them education
              guidance and the opportunities neccesary to build the life they had always hoped for
