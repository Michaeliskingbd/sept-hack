  ...
  return (
   <div className="  bg-black justify-center p-20 ">
      ...
      <div className="grid lg:gap-10 lg:my-0  my-9 gap-3" >
        ...
        <span >
            <p className="lg:w-40 font-mono "> Donate Now
            Volunteer With Us
            Sponsor a Child
            Become a Partner
            Fundraise for Us</p>
        ...
        <span className="grid gap-5 ">
            ...
            <form className=" grid lg:text-start text-center gap-2" action="">
                <input className="lg:py-2 py-3 px-24 lg:px-40 text-black" type="email" required placeholder="Email address" />
                <span>
                    <button className="py-3 text-sm font-bold px-10 lg:px-8 bg-white text-black lg:my-6">SUBMIT</button>
                </span>
            </form>
