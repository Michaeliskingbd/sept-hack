...
const Navbar1 = () => {
  ...
  return (
    ...
    <nav className="relative flex items-center justify-between px-10 py-6 text-white bg-black">
        ...
        <>
{showMobileNav ? (
<IoMdClose onClick={toggleMobileNav} className="lg:hidden flex text-5xl text-red-300"/>
) : (
<MdMenu onClick={toggleMobileNav} className="lg:hidden flex text-5xl text-red-300"/>
)}
</>
        </div>
      </nav>
